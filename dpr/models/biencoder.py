...
class BiEncoder(nn.Module):
    ...
    def create_biencoder_input(
        ...
        for sample in samples:
            ...
            # use neg_ctxs as semantic hard negatives
            ...
            sample_ctxs_tensors = [
                # if you want to add prefix, add it here!
...
class BiEncoderNllLoss(object):
    def calc(
        ...
        """
        # check q_vectors, ctx_vectors dim
        ...
        # N * C
        # do every position of postivie class
        loss = F.nll_loss(
            softmax_scores,
    ...
    def get_scores(q_vector: T, ctx_vectors: T) -> T:
        # check the dim
        # q_vectors: torch.Size([2, 768])
        # ctx_vectors: torch.Size([4, 768])
